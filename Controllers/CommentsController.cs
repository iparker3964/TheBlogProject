...
namespace TheBlogProject.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PostId,Body")] Comment comment, int? PostId)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Moderate(int id,[Bind("Id,Body,ModeratedBody,ModeratedType")] Comment comment)
        {
            if (id != comment.Id)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    newComment.ModeratedType = comment.ModeratedType;
